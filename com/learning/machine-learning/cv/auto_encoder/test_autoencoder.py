...
def plot_denoised_images():
    ...
    resized_test_img = cv2.resize(test_img, (280, 280)) * 255
    cv2.imwrite('noisy_input.jpg', resized_test_img)
    # cv2.imshow('input', resized_test_img)
    # cv2.waitKey(0)
    output = denoised_images[0]
    resized_output = cv2.resize(output, (280, 280)) * 255
    cv2.imwrite('decoded_output.jpg', resized_output)
